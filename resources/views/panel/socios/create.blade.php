                            ...
                            <div class="row">
                                <div class="col-5">
                                    <div class="form-group">
                                        ...
                                        <small id="" class="form-text text-muted">We'll never share your email with
                                            anyone else.</small>
                                    </div>
                                </div>
                                <div class="col-5">
                                ...
                                <div class="col-5">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="cuil_soc" id="cuil_soc"
                                            aria-describedby="dni">
                                        <small id="" class="form-text text-muted">Posible alert.</small>
                                    </div>
                                </div>
                                ...
                                <div class="col-7">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="domicilio" id=""
                                ...
                                <div class="col-10">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="fecha_asociacion"
                                            name="fecha_asociacion" aria-describedby="fecha_nac">
