                                    ...
                                    <tr class="">
                                        ...
                                        <td class="d-flex flex-row-reverse bd-highlight">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="{{ route('Detalle_fact.fin_factura', $fact) }}"
                                                ...
                                                <a href="{{ route('facturas.edit', $fact->num_fac) }}"
                                                    class="btn btn-outline-dark rounded-circle mx-2"
                                                    style="width:2.5em; height:2.5em;">
                                                    <span class="material-symbols-outlined d-flex justify-content-center">
                                                        edit_square
                                                ...
                                                <button type="button" data-toggle="modal" data-target="#deleteModal"
                                                    data-id="{{ $fact->num_fac }}" data-num="{{ $fact->id_caja }}"
                                                    data-soc="{{ $fact->dni_soc }}" data-cli="{{ $fact->dni_cli }}"
                                                    class="btn btn-outline-dark rounded-circle mx-2"
                                                    style="width:2.5em; height:2.5em;">
                                                    <span class="material-symbols-outlined d-flex justify-content-center">
                                                        cancel
