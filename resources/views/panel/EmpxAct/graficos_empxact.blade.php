...
@section('content_header')
    <h1 class="text-center">Datos Estadisticos: Listado actualizado de actividades de los empleados</h1>
@stop
        ...
        $(function() {
            ...
            $.get(location.href, function(response) {
                ...
                if(response.success) {
                    ...
                    graficar(barChart, 'bar', labels, count, 'Listado actualizado de actividades de los empleados', configDataBarChart);

                    // Para Graficar el Diagrama de Torta (PieChart)
                    graficar(pieChart, 'pie', labels, count, 'Listado actualizado de actividades de los empleados', configDataPieChart);
                } else {
