...
@section( 'content' )
    ...
    @endif
        <ul class="list-group">
            ...
            <li class="list-group-item"><strong><u>Actividad:</u></strong> {{ $dxact->actividad->nombre_act . ', '. $dxact->actividad->descripcion_act}}.</li>
            <li class="list-group-item"><strong><u>Día:</strong></u> {{ $dxact->dia->nombre_dia }}</li>
